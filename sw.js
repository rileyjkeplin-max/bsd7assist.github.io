const CACHE='bsd7-community-v1.3.6';
const SHELL=['./','./index.html','./app-v136.js','./supabase-lite.js','./config.js','./update.js','./install.js','./install-ui.css','./manifest.json','./icons/app-192.svg','./icons/app-512.svg','./icons/apple-touch-icon.svg'];

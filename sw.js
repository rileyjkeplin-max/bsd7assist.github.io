const CACHE='bsd7-community-v1.3.15';
const SHELL=['./','./index.html','./app-v1315.js','./supabase-lite.js','./config.js','./update.js','./install.js','./install-ui.css','./manifest.json','./icons/app-192.svg','./icons/app-512.svg','./icons/apple-touch-icon.svg'];
